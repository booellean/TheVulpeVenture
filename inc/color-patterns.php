<?php
/**
 * The Vulpe Venture: Color Patterns
 *
 * @package WordPress
 ...
 */
function thevulpeventure_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter The Vulpe Venture default saturation level.
	 *
	 * @since The Vulpe Venture 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'thevulpeventure_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.thevulpeventure-front-page) .entry-title,
...
.colors-custom .thevulpeventure-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.thevulpeventure-front-page .panel-content .recent-posts article,
...
.colors-custom.thevulpeventure-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters The Vulpe Venture custom colors CSS.
	 *
	 * @since The Vulpe Venture 1.0
	 *
	 ...
	 */
	return apply_filters( 'thevulpeventure_custom_colors_css', $css, $hue, $saturation );
}
